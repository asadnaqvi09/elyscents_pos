<div id="cust-delete-modal" class="modal-overlay" style="z-index:10000;">
    <div class="modal-card delete-card">
        ...
        <h3 class="customer-header-title" style="font-size: 18px; text-align: center;">Delete Customer?</h3>
        <p class="customer-header-subtitle" style="margin: 12px 0 24px; text-align: center; line-height: 1.5;">
            Are you sure you want to delete <span id="delete-cust-name" style="color:#1e293b; font-weight:800;">this customer</span>? This action will remove all transaction history and cannot be undone.
        </p>
